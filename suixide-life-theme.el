...
(let ((suixide-white       "#FFFFFF")
  ...
  (custom-theme-set-faces
   ...
   `(font-lock-function-name-face ((t (:foreground ,suixide-bbblue))))
   `(font-lock-keyword-face ((t (:foreground ,suixide-blue :bold nil))))
   ...
   `(font-lock-type-face ((t (:foreground ,suixide-blue))))
